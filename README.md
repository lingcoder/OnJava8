...
2. 采用第一人称叙述。
3. 针对中英行文差异，避免冗余啰嗦的逐字逐句翻译。部分主题无关的内容和重复描写会被精简掉。

3. 译者在翻译中参考了谷歌翻译，百度翻译，有道翻译的译文以及《Java编程思想》第四版中文版的部分内容，并尽量规避第四版中已知的翻译死板，生造专有名词，语言精炼度差等的翻译问题。最后再结合译者自己的理解，尽量做到专业、简练和语言本地化，方便大家更好的理解学习，同时节约时间。
