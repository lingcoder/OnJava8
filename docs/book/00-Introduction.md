...
Java是一门派生语言，早期语言设计者为了不想在项目中使用 C++ 而创造了这种看起来很像 C++,却比 C++ 有了改进的新语言（他们原始的项目到最后也没有实现）。Java最核心的变化就是加入了“虚拟机”和“垃圾回收机制”，这两个概念在本书之后的章节会有详细描述。 此外，Java 还在其他方面推动行业了发展，例如，现在绝大多数编程语言都包含文档注释语法和 HTML 文档生成的工具。
