...
<span id="table-io-1"/>**表 I/O-1：`InputStream` 类型**
...
<span id="table-io-2"/>**表 I/O-2：`OutputStream` 类型**
...
<span id="table-io-3"/>**表 I/O-3：`FilterInputStream` 类型**
...
<span id="table-io-4"/>**表 I/O-4：`FilterOutputStream` 类型**
