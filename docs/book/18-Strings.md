...
|**`%`**|**字符“%”**|
下面的程序演示了这些转换时如何工作的：
>>>>>>> beacc51a2ed07e07e476d69a2b4c1602e5b5ff4e
```java
...
*/
```
使用正则表达式或`Scanner`对象，我们能够以更加复杂的模式来分割一个字符串，而这对于`StringTokenizer`来说就很困难了。基本上，我们可以放心地说，`StringTokenizer`已经可以废弃不用了[^2]。
